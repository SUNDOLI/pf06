...
$(function () {
    $('#bgndVideo').YTPlayer({
        videoURL: 'https://youtu.be/yEjxz7EUZB4',
        containment: '.main_moive',
        showControls: false,
        playOnlyIfVisible: true,

    });

    $('.main_moive .control .play').on('click', function () {
        $('#bgndVideo').YTPPlay();
    });
    $('.main_moive .control .pause').on('click', function () {
        $('#bgndVideo').YTPPause();
    });
    $('.main_moive .control .fullscreen').on('click', function () {
...
$(function () {
    ...
    const MAINVISUALSLIDE = new Swiper('.main_event_slide', {
        slidesPerView: 4,
        spaceBetween: 30,
        loop: true,
